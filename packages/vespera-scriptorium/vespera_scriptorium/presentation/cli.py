...
from ..domain import StateRepository, TaskRepository
...
class CLIInterface:
    """
    Command-line interface for the Vespera Scriptorium.
    ...
    async def health_check(self) -> int:
        ...
        """
        print("Running Vespera Scriptorium health checks...")
    ...
    def show_config(self) -> int:
        ...
        try:
            ...
            print("📋 Vespera Scriptorium Configuration:")
            ...
            print(
                f"  DI Enabled: {self.config_manager.is_dependency_injection_enabled()}"
            )
    ...
    def create_parser(self) -> argparse.ArgumentParser:
        ...
        parser = argparse.ArgumentParser(
            description="Vespera Scriptorium CLI",
        ...
        server_parser.add_argument(
            "--config-file", type=Path, help="Server configuration file"
        )
