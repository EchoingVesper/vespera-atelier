...
from .lifetime_managers import (
    ...
    LifetimeScope,
    ServiceScope,
    create_lifetime_manager,
)
from .registration import (
    AutoRegistration,
    ServiceRegistrar,
    ServiceRegistration,
    create_factory_with_dependencies,
)
...
class ServiceContainer:
    ...
    def __init__(self):
        ...
        self._services[ServiceContainer] = create_lifetime_manager(
            lambda: self, LifetimeScope.SINGLETON
        )
        ...
        with self._lock:
            ...
            if registration.factory:
                ...
                factory = create_factory_with_dependencies(
                    registration.implementation_type, registration.dependencies
                )
            else:
...
def auto_register_repositories(repository_module, implementation_module):
    ...
    AutoRegistration.register_repositories(
        registrar, repository_module, implementation_module
    )
    registrar.build()
