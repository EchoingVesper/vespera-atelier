...
async def create_async_repository_factory(
    config: Dict[str, Any],
    ...
    if "operational" not in database_config:
        ...
        database_config["operational"] = {
            "url": "sqlite:///vespera_scriptorium.db",
            "timeout": 30.0,
        }
...
class RepositoryConfiguration:
    ...
    def create_sqlite_config(
        database_path: str = "vespera_scriptorium.db", timeout: float = 30.0, **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    def create_multi_db_config(
        sqlite_path: str = "vespera_scriptorium.db",
        ...
        config = {
            "databases": {
                "operational": {"url": f"sqlite:///{sqlite_path}", "timeout": 30.0}
            }
        }
