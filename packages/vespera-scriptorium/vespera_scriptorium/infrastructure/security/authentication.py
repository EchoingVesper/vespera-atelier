"""
Authentication Framework for Vespera Scriptorium
...
class APIKeyManager:
    ...
    def __init__(self, storage_path: Optional[str] = None):
        ...
        self.storage_path = Path(storage_path or ".vespera_scriptorium/api_keys.json")
        self.storage_path.parent.mkdir(parents=True, exist_ok=True)
        self._keys: Dict[str, Dict] = {}
        self._load_keys()

    def generate_api_key(
        self, description: str = "Generated API Key", expires_days: Optional[int] = None
    ) -> str:
        """
...
class AuthenticationValidator:
    ...
    def require_authentication(self, func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if not is_valid:
                security_logger.warning(
                    f"Authentication failed for operation: {func.__name__}"
                )
...
def generate_api_key(
    description: str = "Generated API Key", expires_days: Optional[int] = None
) -> str:
