...
class HandlerMigrationManager:
    ...
    def __init__(self):
        ...
        use_pydantic_handlers = (
            os.getenv("MCP_USE_PYDANTIC_HANDLERS", "false").lower() == "true"
        )
        ...
        self.handler_configs: Dict[str, HandlerConfig] = {
            ...
            "orchestrator_create_generic_task": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("CREATE_TASK"),
            ...
            "orchestrator_update_task": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("UPDATE_TASK"),
            ...
            "orchestrator_delete_task": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("DELETE_TASK"),
            ...
            "orchestrator_cancel_task": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("CANCEL_TASK"),
            ...
            "orchestrator_query_tasks": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("QUERY_TASKS"),
            ...
            "orchestrator_execute_task": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("EXECUTE_TASK"),
            ...
            "orchestrator_complete_task": HandlerConfig(
                ...
                use_new=use_pydantic_handlers
                or self._check_specific_flag("COMPLETE_TASK"),
