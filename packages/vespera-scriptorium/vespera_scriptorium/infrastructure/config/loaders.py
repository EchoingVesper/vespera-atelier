...
class EnvironmentConfigLoader:
    ...
    def _load_logging_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "log_to_file": (
                self._get_env_bool("LOG_TO_FILE")
                if self._get_env("LOG_TO_FILE")
                else None
            ),
    ...
    def _load_orchestration_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "enable_dependency_injection": (
                self._get_env_bool("USE_DI") if self._get_env("USE_DI") else None
            ),
        }
    ...
    def _load_workspace_config(self) -> Dict[str, Any]:
        ...
        return {
            "workspace_dir": self._get_env("WORKSPACE_DIR")
            or self._get_env("PROJECT_DIR"),
    ...
    def _load_external_config(self) -> Dict[str, Any]:
        ...
        return {
            "enable_notifications": (
                self._get_env_bool("ENABLE_NOTIFICATIONS")
                if self._get_env("ENABLE_NOTIFICATIONS")
                else None
            ),
    ...
    def _load_performance_config(self) -> Dict[str, Any]:
        ...
        return {
            "enable_metrics": (
                self._get_env_bool("ENABLE_METRICS")
                if self._get_env("ENABLE_METRICS")
                else None
            ),
...
class DefaultConfigLoader:
    ...
    def load(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Workspace defaults
            "artifacts_dir": ".vespera_scriptorium/artifacts",
