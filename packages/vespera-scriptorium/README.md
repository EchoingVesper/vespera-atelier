...
[![Version 1.0.0](https://img.shields.io/badge/version-1.0.0-green.svg)](https://github.com/vespera-atelier/vespera-atelier/releases/tag/v1.0.0)
...
Vespera Scriptorium provides intelligent task orchestration, specialized AI roles, and persistent memory for AI-assisted development. Built with Clean Architecture principles, it automatically detects project structure and saves artifacts appropriately.

**Document Type**: Project Overview & User Guide  
**Target Audience**: Developers using MCP clients (Claude Desktop, Cursor, VS Code, etc.)  
**Prerequisites**: Python 3.10+, MCP-compatible client  
...
### Installation
1. **Install**: `pip install vespera-scriptorium`
2. **Configure**: Add to your MCP client configuration
3. **Use**: "Initialize orchestrator session and help me build a REST API"
