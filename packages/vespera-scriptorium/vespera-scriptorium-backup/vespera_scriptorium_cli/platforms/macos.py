"""
macOS-specific implementation for Vespera Scriptorium CLI.

This module provides macOS-specific functionality for detecting and configuring
MCP clients on macOS operating systems.
"""
...
# Client configuration paths for macOS
CLIENT_PATHS = {
    "claude_desktop": {
...
def detect_clients():
    """
    Detect installed MCP clients on macOS.
