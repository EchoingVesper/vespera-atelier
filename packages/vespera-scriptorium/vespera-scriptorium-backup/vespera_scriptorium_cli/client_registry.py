...
class ClientRegistry:
    ...
    def __init__(self, registry_path: Optional[Path] = None):
        ...
        if registry_path is None:
            ...
            possible_paths = [
                ...
                Path("/usr/local/share/vespera-scriptorium/config/mcp_clients_registry.yaml"),
                # User config location
                Path.home() / ".config" / "vespera-scriptorium" / "mcp_clients_registry.yaml"
            ]
        ...
        self.vespera_scriptorium_config = {}
    ...
    def load_registry(self):
        ...
        try:
            ...
            # Load Vespera Scriptorium config
            self.vespera_scriptorium_config = data.get('task_orchestrator_config', {})
    ...
    def get_task_orchestrator_config(self) -> Dict[str, Any]:
        """Get Vespera Scriptorium configuration."""
        config = self.vespera_scriptorium_config.copy()
    ...
    def create_full_config(self, client_id: str, python_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            orchestrator_in_source = ("Programming" in orchestrator_path and 
                                    "vespera-scriptorium" in orchestrator_path)
