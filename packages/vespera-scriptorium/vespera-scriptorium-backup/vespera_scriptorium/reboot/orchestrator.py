...
class RestartOrchestrator:
    ...
    async def attempt_hot_reload_first(
        self, reason: str = "manual_request"
    ) -> Dict[str, Any]:
        """
    ...
    async def perform_restart(
        ...
        hot_reload_unavailable: bool = False,
    ) -> Dict[str, Any]:
        """
...
async def orchestrate_restart(
    ...
    result.update(
        {"graceful": graceful, "preserve_state": preserve_state, "timeout": timeout}
    )
