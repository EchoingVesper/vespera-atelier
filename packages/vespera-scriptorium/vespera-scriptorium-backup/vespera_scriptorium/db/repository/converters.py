...
def row_to_dependency(row: Dict) -> TaskDependency:
    ...
    return TaskDependency(
        ...
        satisfaction_criteria=(
            json.loads(row["satisfaction_criteria"])
            if row["satisfaction_criteria"]
            else None
        ),
        output_artifact_ref=row["output_artifact_ref"],
        input_parameter_name=row["input_parameter_name"],
        waived_at=(
            datetime.fromisoformat(row["waived_at"]) if row.get("waived_at") else None
        ),
