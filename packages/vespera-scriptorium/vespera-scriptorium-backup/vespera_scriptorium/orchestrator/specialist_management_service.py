...
class SpecialistManager:
    ...
    def __init__(self, config_path: str = None, project_dir: str = None):
        ...
        self.persistence_dir = Path(self.project_dir) / ".vespera_scriptorium"
        ...
        if config_path is None:
            try:
                ...
                if config_dir:
                    ...
                    # First check in the .vespera_scriptorium/roles directory
                    ...
                    if persistence_config.exists():
                        ...
                        if config_path.exists() and not persistence_config.exists():
                            self._migrate_config_to_persistence(
                                config_path, persistence_config
                            )
    ...
    def _migrate_config_to_persistence(
    ...
    async def get_specialist_prompt(
        self, specialist_type: SpecialistType, subtask: Task
    ) -> str:
        ...
        specialist_config = self.specialists_config.get(
            ...
            self._get_default_specialists_config()[specialist_type.value],
        )
...
"""
    ...
    async def synthesize_task_results(
        self, parent_task_id: str, completed_subtasks: List[Task]
    ) -> str:
        ...
        for specialist_type, subtasks in by_specialist.items():
            ...
            for subtask in subtasks:
                ...
                if subtask.artifacts:
                    synthesis_parts.append(
                        f"**Artifacts:** {', '.join(subtask.artifacts)}"
                    )
                synthesis_parts.append("")
