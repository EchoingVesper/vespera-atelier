#!/usr/bin/env python3
"""
Entry point module for Vespera Scriptorium server.
...
def main_sync():
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            description="Vespera Scriptorium Server",
            formatter_class=argparse.RawDescriptionHelpFormatter,
        )
        parser.add_argument(
            "--version", "-V", action="version", version="Vespera Scriptorium 1.8.0"
        )
        parser.add_argument(
        ...
        print("Please run: pip install vespera-scriptorium", file=sys.stderr)
        sys.exit(1)
