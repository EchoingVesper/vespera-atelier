...
from ...domain import OrchestrationError, Task, TaskValidationError
        ...
        try:
            ...
            if validation_errors:
                raise TaskValidationError(
                    "Invalid task plan request", validation_errors
                )
            ...
            raise OrchestrationError(
                f"Failed to plan task: {str(e)}", {"request": request.__dict__}
            )
