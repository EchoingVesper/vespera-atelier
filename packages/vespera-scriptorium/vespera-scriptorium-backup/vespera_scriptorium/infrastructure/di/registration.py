...
from .lifetime_managers import LifetimeManager, LifetimeScope, create_lifetime_manager
...
class ServiceRegistrar:
    ...
    def register_type(
        self, service_type: Type[TInterface], implementation_type: Type[TImplementation]
    ) -> "ServiceRegistrar":
        """
        ...
        registration = ServiceRegistration(
            service_type=service_type, implementation_type=implementation_type
        )
    ...
    def register_factory(
        ...
        Returns:
            Self for method chaining
        """
        registration = ServiceRegistration(service_type=service_type, factory=factory)
        self._registrations[service_type] = registration
        return self
...
class AutoRegistration:
    ...
    def register_from_module(
        ...
        implementation_suffix: str = "Repository",
    ) -> ServiceRegistrar:
        """
    ...
    def register_repositories(
        registrar: ServiceRegistrar, repository_module: Any, implementation_module: Any
    ) -> ServiceRegistrar:
        """
        ...
        for name in dir(repository_module):
            ...
            if (
                inspect.isclass(obj)
                and obj.__module__ == repository_module.__name__
        ...
        for name in dir(implementation_module):
            ...
            if (
                inspect.isclass(obj)
                and obj.__module__ == implementation_module.__name__
            ):
...
def create_factory_with_dependencies(
    implementation_type: Type[T], dependencies: Optional[Dict[str, Type]] = None
) -> ServiceFactory:
    """
