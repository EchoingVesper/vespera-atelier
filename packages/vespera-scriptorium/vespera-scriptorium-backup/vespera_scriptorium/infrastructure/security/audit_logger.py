"""
Security Audit Logging Framework for Vespera Scriptorium
...
class SecurityAuditLogger:
    ...
    def log_authentication_success(
        self, user_id: str, details: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def log_authentication_failure(
        self, attempted_user: str, reason: str, details: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def log_role_assignment(
        self, target_user: str, role: str, assigner_user: Optional[str] = None
    ) -> None:
    ...
    def get_recent_events(
        ...
        severity_levels: Optional[List[SecurityLevel]] = None,
    ) -> List[Dict[str, Any]]:
        """
...
def log_authz_failure(
    ...
    security_audit_logger.log_authorization_failure(
        user_id, permission, operation, details
    )
