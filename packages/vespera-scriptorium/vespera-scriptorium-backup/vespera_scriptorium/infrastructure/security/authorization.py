"""
Authorization Framework for Vespera Scriptorium
    ...
    def get_role_hierarchy_info(self) -> Dict[str, Dict]:
        ...
        for role in Role:
            ...
            info[role.value] = {
                ...
                "direct_permissions": [
                    p.value for p in self.ROLE_PERMISSIONS.get(role, set())
                ],
            }
...
class UserRoleManager:
    ...
    def assign_user_role(self, user_id: str, role: Role) -> bool:
        ...
        try:
            ...
            security_logger.info(f"Role assigned: user_id={user_id}, role={role.value}")
            return True
    ...
    def _load_user_roles(self) -> None:
        ...
        self._user_roles = {"default_admin": Role.ADMIN, "system": Role.ADMIN}
...
class AuthorizationValidator:
    ...
    def require_role(self, required_role: Role):
        ...
        def decorator(func):
            ...
            async def wrapper(*args, **kwargs):
                ...
                required_permissions = self.role_manager.get_role_permissions(
                    required_role
                )
    ...
    def _extract_user_id(
        self, auth_metadata: Dict, request_kwargs: Dict
    ) -> Optional[str]:
        """
