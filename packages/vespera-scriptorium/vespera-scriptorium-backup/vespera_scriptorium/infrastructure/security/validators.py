"""
Input Validation Framework for Vespera Scriptorium
...
class PathValidator:
    ...
    def validate_file_path(
        self, path: str, base_dir: Union[str, Path], field_name: str = "path"
    ) -> Path:
        """
...
def validate_string_input(
    value: str, field_name: str = "input", max_length: int = 1000
) -> str:
...
def validate_file_path(
    path: str, base_dir: Union[str, Path], field_name: str = "path"
) -> Path:
