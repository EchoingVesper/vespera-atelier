...
class ResponseFormatter:
    ...
    def format_task_dict(task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        formatted_task = {
            ...
            "task_type": str(
                task_data.get("type", task_data.get("task_type", "standard"))
            ),
        }
        ...
        if isinstance(metadata_raw, str):
            try:
                ...
                logger.warning(
                    f"Invalid JSON in metadata for task {formatted_task['task_id']}"
                )
                metadata = {}
        else:
    ...
    def format_update_response(
        task_dict: Dict[str, Any], changes: List[str]
    ) -> Dict[str, Any]:
    ...
    def format_query_response(
        tasks: List[Dict[str, Any]], query_context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def format_delete_response(
        task_id: str, action: str, metadata: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def format_cancel_response(
        task_id: str, cancellation_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        response = {
            ...
            "dependent_tasks_updated": cancellation_data.get(
