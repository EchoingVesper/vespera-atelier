...
from ..value_objects.specialist_type import (
    SpecialistCapability as SpecialistCapabilityVO,
)
from ..value_objects.specialist_type import (
    SpecialistType,
)
...
class Specialist:
    ...
    def create_architect(cls) -> "Specialist":
        ...
        return cls(
            ...
            capabilities=[
                SpecialistCapabilityVO(
                    "System Design", "Create comprehensive system architectures", 0.95
                ),
                SpecialistCapabilityVO(
                    "Pattern Recognition", "Identify and apply design patterns", 0.9
                ),
                SpecialistCapabilityVO(
                    "Technology Assessment", "Evaluate technology choices", 0.85
                ),
            ],
    ...
    def create_implementer(cls) -> "Specialist":
        ...
        return cls(
            ...
            capabilities=[
                SpecialistCapabilityVO(
                    "Code Implementation", "Write production-quality code", 0.95
                ),
                SpecialistCapabilityVO(
                    "Problem Solving", "Solve technical challenges", 0.9
                ),
                SpecialistCapabilityVO(
                    "Optimization", "Optimize code performance", 0.8
                ),
            ],
    ...
    def create_reviewer(cls) -> "Specialist":
        ...
        return cls(
            ...
            capabilities=[
                SpecialistCapabilityVO(
                    "Code Review", "Identify issues and improvements", 0.95
                ),
                SpecialistCapabilityVO(
                    "Security Analysis", "Spot security vulnerabilities", 0.85
                ),
                SpecialistCapabilityVO(
                    "Performance Analysis", "Identify performance issues", 0.8
                ),
            ],
...
class SpecialistContext:
    ...
    def build_prompt(self) -> str:
        ...
        sections = [self.specialist.system_prompt, f"\nTask: {self.task_description}"]
