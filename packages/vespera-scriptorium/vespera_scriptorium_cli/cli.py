"""
Command-line interface for Vespera Scriptorium.

This module provides the main CLI functionality for installing, configuring,
and managing the Vespera Scriptorium server.
"""
...
def get_server_module_path():
    ...
    try:
        ...
        dist = pkg_resources.get_distribution("vespera-scriptorium")
...
app = typer.Typer(
    ...
    help="Vespera Scriptorium CLI - Installation and configuration tools"
)
...
def install(
    server_path: Optional[str] = typer.Argument(
        None, 
        help="Path to the Vespera Scriptorium server script (auto-detected if not provided)"
    ),
    ...
    """
    Install and configure the Vespera Scriptorium server.
    """
    console.print("[bold green]Vespera Scriptorium - Installation[/bold green]")
    ...
    if server_path is None:
        ...
        if server_path is None:
            ...
            console.print("Please provide the path explicitly or ensure vespera-scriptorium is properly installed.")
...
def update(
    server_path: str = typer.Argument(
        ..., 
        help="New path to the Vespera Scriptorium server script"
    ),
    name: str = typer.Option(
        "Task Orchestrator", 
        "--name", "-n", 
    ...
    """
    console.print("[bold green]Vespera Scriptorium - Update[/bold green]")
...
def uninstall(
    ...
    """
    Remove Vespera Scriptorium configuration from clients.
    """
    console.print("[bold red]Vespera Scriptorium - Uninstallation[/bold red]")
    ...
    console.print("\n[bold]Removing Vespera Scriptorium configuration...[/bold]")
    success_count = 0
...
def setup(
    ...
    This is the simplest way to configure Vespera Scriptorium after installation.
    It will:
    ...
    """
    console.print("[bold green]Vespera Scriptorium - Quick Setup[/bold green]")
    ...
    try:
        ...
        console.print("Please run: vespera-scriptorium-cli check-deps")
        raise typer.Exit(code=1)
    ...
    if server_path is None:
        ...
        console.print("Please ensure vespera-scriptorium is properly installed:")
        console.print("  pip install vespera-scriptorium")
        raise typer.Exit(code=1)
...
def check_deps():
    """
    Check and install missing dependencies for Vespera Scriptorium.
    """
    console.print("[bold green]Vespera Scriptorium - Dependency Check[/bold green]")
