#!/usr/bin/env python3
"""
Universal Vespera Scriptorium Installer

This installer detects and configures Vespera Scriptorium for all known MCP clients
...
class ClaudeDesktopConfig(MCPClientConfig):
    ...
    def configure(self, server_path: str, python_path: str = None) -> bool:
        ...
        # Add Vespera Scriptorium configuration
...
class UniversalInstaller:
    ...
    def check_dependencies(self) -> bool:
        ...
        if externally_managed and not in_venv:
            ...
            console.print("3. Install vespera-scriptorium:")
            console.print("   [cyan]pip install vespera-scriptorium[/cyan]")
            console.print("4. Run setup:")
            console.print("   [cyan]vespera-scriptorium-cli setup[/cyan]")
            
            console.print("\n[dim]Alternative: Use pipx for isolated installation:[/dim]")
            console.print("   [cyan]pipx install vespera-scriptorium[/cyan]")
            console.print("   [cyan]pipx run vespera-scriptorium-cli setup[/cyan]")
    ...
    def find_server_module(self) -> Optional[str]:
        """Find the Vespera Scriptorium server module."""
    ...
    def run(self):
        ...
        console.print(Panel.fit(
            "[bold cyan]Vespera Scriptorium Universal Installer[/bold cyan]\n"
